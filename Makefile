...
INC = 
CFLAGS = -Wall -I/usr/local/lib/wx/include/gtk3-unicode-3.2 -I/usr/local/include/wx-3.2 -D_FILE_OFFSET_BITS=64 -DWXUSINGDLL -D__WXGTK__ -pthread
RESINC = 
LIBDIR = 
LIB = 
LDFLAGS = `wx-config --libs`

INC_DEBUG = $(INC) -I../wx_lab_1
...
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/wx_lab_1

INC_RELEASE = $(INC) -I../wx_lab_1
...
DEP_RELEASE = 
OUT_RELEASE = bin/Release/wx_lab_1
